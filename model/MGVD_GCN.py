...
class MGVD(torch.nn.Module):
    def __init__(self, hidden_channels, num_classes):
        ...
        self.raw_graph_GCN = GCN(hidden_channels, num_classes)
        self.abstract_graph_GCN = GCN(hidden_channels, num_classes)
    ...
    def forward(self, raw_data, abstract_data, sequence, device):
        ...
        feature_matrix = torch.cat((raw_graphs_matrix, abstract_graphs_matrix, sequence), dim=0)
