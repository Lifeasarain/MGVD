...
def joernGraph(dataPath, outPath, dataTag, sourceCodePath):
        ...
        try:
            with open(path, 'r', encoding='utf-8') as f:
                ...
                if (alllist[1] != "" and alllist[0].find(".c-<global>")<0 and alllist[0].find(".c")>0 and alllist[0].find(".c-VAR")<0):
                    ...
                    source = []
                    # TODO 根据不同数据集要进行调整
                    # with open(sourceCodePath+"/"+filename[:16], 'r', encoding='utf-8') as f1:
                    with open(sourceCodePath+"/"+filename.split("-")[0], 'r', encoding='utf-8') as f1:
...
if __name__ == '__main__':
    data_path = "/home/qiufangcheng/workspace/IVDetect/testdata/auto/raw_graphs_nj"
    # dataPath = "/home/qiufangcheng/workspace/SGS/test_data/sard_test/raw_result_old"
    # dataPath = "/home/qiufangcheng/workspace/SGS/data/sard1/raw_result/Vul"
    # dataPath = "raw_result/cwe119"
    # dataPath = "/home/qiufangcheng/workspace/SGS/test_data/raw_result"

    out_path = "/home/qiufangcheng/workspace/IVDetect/testdata/auto/med_graphs_nj"
    # outPath = "/home/qiufangcheng/workspace/SGS/test_data/sard_test/result_old"
    # outPath = "/home/qiufangcheng/workspace/SGS/data/sard1/result/Vul"
    # outPath = "result/cwe119"
    # outPath = "/home/qiufangcheng/workspace/SGS/test_data/result"

    data_tag = "bad"
    source_path = "/home/qiufangcheng/workspace/IVDetect/testdata/auto/raw"
    # sourcePath = 'data/clean'
    # sourcePath = "/home/qiufangcheng/workspace/SGS/test_data/sard_test/normalize"
    # sourcePath = "/home/qiufangcheng/workspace/SGS/data/sard1/raw/Vul_normalize"
    # sourcePath = "/home/qiufangcheng/workspace/SGS/test_data/raw"

    joernGraph(data_path, out_path, data_tag, source_path)
